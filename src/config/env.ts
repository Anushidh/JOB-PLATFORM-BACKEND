...
const env: EnvConfig = {
  ...
  ADMIN_EMAIL: process.env.ADMIN_EMAIL || (process.env.NODE_ENV === 'production' ? '' : 'admin@hireflow.dev'),
  ADMIN_PASSWORD: process.env.ADMIN_PASSWORD || (process.env.NODE_ENV === 'production' ? '' : 'Admin@123456'),
};
